import ProductTypesActions, { MODEL, IGNORE_ACTIONS, PRIMARY_KEY } from './actions';
...
export default [...rootCRUDSaga(MODEL, IGNORE_SAGAS, ProductTypesActions, PRIMARY_KEY)];
