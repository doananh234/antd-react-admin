import ActivityTypesActions, { MODEL, IGNORE_ACTIONS, PRIMARY_KEY } from './actions';
...
export default [...rootCRUDSaga(MODEL, IGNORE_SAGAS, ActivityTypesActions, PRIMARY_KEY)];
