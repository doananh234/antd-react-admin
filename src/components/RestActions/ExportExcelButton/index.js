...
const exportExcel = (resource, resourceFilter) => () => {
  ...
  request.open('GET', `${process.env.REACT_APP_SERVER_URL}/${resource}/exportExcel?${query}`);
  ...
  request.onload = () => {
    if (request.status === 200) {
      ...
      const filename = matches != null && matches[1] ? matches[1] : `${resource}.xlsx`;
      // The actual download
...
const ExportExcelButton = ({ resource, resourceFilter }) => (
  <ButtonWrapper onClick={exportExcel(resource, resourceFilter)}>
    <svg
      width="21px"
      height="20px"
      viewBox="0 0 21 20"
    ...
    >
      ...
      <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="ic/-text-size-copy" transform="translate(-2.000000, -2.000000)">
